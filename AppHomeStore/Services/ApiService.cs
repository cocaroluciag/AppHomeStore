using AppHomeStore.mvvm.Models;
...
public class ApiService
{
    ...
    public async Task<LoginResponseDto> ValidarLogin(string _idusuario, string _clave)
    {
    ...
    public static async Task<Producto> GetProductoPorId(int id)
    {
        ...
        string URL = "https://localhost:7269/api/Productos/ObtenerPorId/" + id;
